...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Presenter.available'
        db.add_column('scheduler_presenter', 'available', orm['scheduler.presenter:available'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Presenter.available'
        db.delete_column('scheduler_presenter', 'available')
